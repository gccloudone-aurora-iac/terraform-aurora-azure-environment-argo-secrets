...
resource "azurerm_key_vault_secret" "velero_aadpodidentity_client_id" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-velero-aadpodidentity-client-id"
...
resource "azurerm_key_vault_secret" "velero_aadpodidentity_resource_id" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-velero-aadpodidentity-resource-id"
...
resource "azurerm_key_vault_secret" "velero_storage_account_name" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-velero-sa-name"
...
resource "azurerm_key_vault_secret" "velero_storage_account_resource_group_name" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-velero-sa-resource-group-name"
