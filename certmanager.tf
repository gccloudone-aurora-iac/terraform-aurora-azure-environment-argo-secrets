...
resource "azurerm_key_vault_secret" "certmanager_aadpodidentity_client_id" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-certmanager-aadpodidentity-client-id"
...
resource "azurerm_key_vault_secret" "certmanager_aadpodidentity_resource_id" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-certmanager-aadpodidentity-resource-id"
