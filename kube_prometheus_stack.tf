...
resource "azurerm_key_vault_secret" "grafana_azuread_oauth_sp_client_id" {
  name         = "${module.azure_resource_prefixes.prefix}-grafana-sp-client-id"
...
resource "azurerm_key_vault_secret" "grafana_azuread_oauth_sp_client_secret" {
  name         = "${module.azure_resource_prefixes.prefix}-grafana-sp-client-secret"
...
resource "azurerm_key_vault_secret" "grafana_password" {
  name         = "${module.azure_resource_prefixes.prefix}-grafana-admin-password"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_jira_api_url" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-jira-api-url"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_jira_user" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-jira-user"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_jira_password" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-jira-password"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_testing" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-testing"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_prod_critical" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-prod-critical"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_prod_major" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-prod-major"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_prod_minor" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-prod-minor"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_non_prod_critical" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-non-prod-critical"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_non_prod_major" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-non-prod-major"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_non_prod_minor" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-non-prod-minor"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_dev_critical" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-dev-critical"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_dev_major" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-dev-major"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_msteams_dev_minor" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-msteams-connector-dev-minor"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_smtp_smarthost" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-smtp-smarthost"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_smtp_username" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-smtp-username"
...
resource "azurerm_key_vault_secret" "alertmanager_notifications_smtp_password" {
  ...
  name         = "${module.azure_resource_prefixes.prefix}-alertmanager-notifications-smtp-password"
