...
resource "azurerm_key_vault_secret" "loki_user" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-loki-user"
...
resource "azurerm_key_vault_secret" "loki_password" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-loki-password"
...
resource "azurerm_key_vault_secret" "loki_authorization" {
  name         = "${module.azure_resource_names.key_vault_secret_name}-loki-authorization"
